...
#SBATCH --mem=50GB
#SBATCH --gres=gpu:2
#SBATCH --dependency=afterany:57538122
...
singularity exec --nv $GROUP_HOME/singularity/rgb-building1.sif python3 run_deeplab.py --backbone=drn_c42 --out-stride=8 --dataset=OSM \
    ...
    --data-root=/oak/stanford/groups/deho/building_compliance/san_jose_naip_512/phase2/ --loss-weights-param=1.05 --preempt-robust